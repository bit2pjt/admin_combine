				...
				<div class="card-body2">
					<div class="content-body">
						<ul>
							...
							<li>
								<div class="ct" style="width: 50%;">
									<strong>작성일 :</strong> <span>${boardShareVO.bs_reg_date}</span>
								</div>
							</li>
							<li><strong>글제목 : </strong> <span>${boardShareVO.bs_title}</span></li>
							<li style="margin-top:20px;">
								<div class="abc">
									<code cols="10" rows="10" readonly>${boardShareVO.bs_content}</code>
								</div>
								<div class="btns">
