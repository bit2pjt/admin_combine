	...
	<div class="page-container">
		...
		<div class="sidebar-menu">
			<div class="sidebar-header">
				<div class="logo">
					<a href="/admin/"><span
						style="color: white; font-weight: bold; font-size: 30px;">BlockBuster</span></a><br>
